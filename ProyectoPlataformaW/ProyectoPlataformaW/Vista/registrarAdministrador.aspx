<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="registrarAdministrador.aspx.cs" Inherits="ProyectoPlataformaW.RegistrarAdministrador" %>
...
<body>
    <h2> 
        ...
        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; REGISTRAR ADMINISTRADOR<asp:Image ID="Image3" runat="server" Height="100px" ImageUrl="~/Imagenes/jefe.png" Width="112px" />
            </strong></p>
    <p style="text-align: center" class="auto-style2"  >
    ...
    <table class="table table-bordered table-hover table-activ border-warning">
        ...
        <tr>
            <td class="auto-style5 border-warning">TIPO DE ADMINISTRADOR</td>
           <td class="border-warning">
               <asp:DropDownList ID="dpdTipo" runat="server" Height="51px" Width="164px">
                   <asp:ListItem>SECRETARIA</asp:ListItem>
                   <asp:ListItem>ASISTENTE</asp:ListItem>
                   <asp:ListItem>RECTOR</asp:ListItem>
                   <asp:ListItem>PRACTICANTE</asp:ListItem>
               </asp:DropDownList>
            </td>
