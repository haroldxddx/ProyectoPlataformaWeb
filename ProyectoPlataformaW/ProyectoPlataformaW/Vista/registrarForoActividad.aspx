<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageProfesor.Master" AutoEventWireup="true" CodeBehind="registrarForoActividad.aspx.cs" Inherits="ProyectoPlataformaW.Vista.registrarForoActividad" %>
       ...
       <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                  ...
                  <asp:LinkButton ID="lkbForo" runat="server" class="nav-link" href="/Vista/forosTotalesAct.aspx">Foros Actividades</asp:LinkButton>
              </li>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Registro de Foros</h3>
...
&nbsp;<asp:TextBox ID="txtTitulo" runat="server" placeholder="Ingrese Titulo del Foro" class="form-control"></asp:TextBox>
              </div>
              <div class="form-group">
                ...
                <div class="form-group">
                <label for="inputClientCompany">Imagen</label>               
                  <asp:FileUpload ID="fluImagen" runat="server" class="form-control"/>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="inputClientCompany">Tipo</label>
                   <br />
                  
                   <asp:DropDownList ID="ddlTipo" runat="server">
                       <asp:ListItem>Seleccione el tipo</asp:ListItem>
                       <asp:ListItem>Preguntas</asp:ListItem>
                       <asp:ListItem>Evaluacion </asp:ListItem>
                       <asp:ListItem>Personales</asp:ListItem>
                   </asp:DropDownList>
              </div>
                <div class="form-group">
                <label for="inputClientCompany">Actividad</label>               
