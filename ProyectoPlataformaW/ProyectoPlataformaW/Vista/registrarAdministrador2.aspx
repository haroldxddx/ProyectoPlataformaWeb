<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="registrarAdministrador2.aspx.cs" Inherits="ProyectoPlataformaW.Vista.registrarAdministrador2" %>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-dark">
	       ...
	       <div class="form-group">
                <label for="inputClientCompany">Tipo de Administrador</label>
                
                <br />
                
                <asp:DropDownList ID="dpdTipo" class="form-control" runat="server">
           ...
           <asp:Button ID="btnRegistrarP" type="submit" runat="server" class="btn btn-outline-warning float-right" Text="Registrar" OnClick="btnRegistrarP_Click"/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
      </div>
            </div>
