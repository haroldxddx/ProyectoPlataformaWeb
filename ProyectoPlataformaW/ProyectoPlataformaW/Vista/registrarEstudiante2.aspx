                        ...
                        <div class="auto-style2">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:GridView ID="dtgExc" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" class="btn btn-success float-right" Height="22px" Text="Ver datos de excel"></asp:LinkButton>

                                            <asp:FileUpload ID="FileUpload1" runat="server" OnClick="UploadButton_Click"></asp:FileUpload>
                                            <asp:Label ID="lblEstado" runat="server" Text="" ></asp:Label>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnRegistrarExc" type="submit" runat="server" class="btn btn-success float-right" Text="Guardar datos de excel" OnClick="Button1_Click" />
                                    </div>
                                </div>
