                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:GridView ID="dtgExc" runat="server" CssClass="auto-style4" Height="143px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <asp:FileUpload ID="FileUpload1" runat="server" Text="Subir Archivo Excel" OnClick="UploadButton_Click" Width="1284px"></asp:FileUpload>
                                            <asp:Label ID="Label1" runat="server" ></asp:Label>
                                            <asp:LinkButton ID="LinkButton1" runat="server"  class="btn btn-success float-right" OnClick="LinkButton1_Click">Ver datos del documento</asp:LinkButton>
