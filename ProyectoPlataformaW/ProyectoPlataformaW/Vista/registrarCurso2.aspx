<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="registrarCurso2.aspx.cs" Inherits="ProyectoPlataformaW.Vista.registrarCurso2" %>
        ...
        <div class="col-md-6">
          <div class="card card-dark">
	       ...
	       <div class="form-group">
                <label for="inputClientCompany">Grado</label>
                
                <br />
                
                <asp:DropDownList ID="dplGrado" class="form-control" runat="server">
                ...
                <asp:TextBox ID="txtCur" runat="server" placeholder="Ingrese Curso" class="form-control"></asp:TextBox>
              </div>
           ...
           <asp:Button ID="btnRegistrarC" type="submit" runat="server" class="btn-outline-warning float-right" Text="Registrar" OnClick="btnRegistrarP_Click"/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
      </div>
            </div>
